<?php
$page_title = 'Stand Blog Home Page';
$page = 'home';
      ...
      <div class="col-lg-8">
        <div class="all-blog-posts">
          <div class="row">
            ...
            <?php
            $all_post = $blog->getAllByTableName('posts');

            if (mysqli_num_rows($all_post)) {
              while ($post_row = $all_post->fetch_assoc()) { ?>

                <div class="col-lg-12">
                  <div class="blog-post">
                    <div class="blog-thumb">
                      <img src="./upload/<?php echo $post_row['post_img']; ?>" alt="">
                    </div>
                    <div class="down-content">
                      <span>
                        <?php
                        // Get Catagory Name
                        $cata_data = $blog->getDataById('catagory', $post_row['post_cata']);
                        $cata_row = $cata_data->fetch_assoc();
                      ...
                      <ul class="post-info">
                        <li><a href="#"><?php echo $post_row['post_author']; ?></a></li>
                        <li><a href="#"><?php echo $post_row['post_date']; ?></a></li>
                        <li><a href="#"><?php echo $post_row['post_comment_count']; ?> Comment</a></li>
                      </ul>
                      <p>
                        <?php
                        $post_dec = $post_row['post_desc'];
                        $word_counter = str_word_count($post_dec);

                        if ($word_counter > 60) {
                          $word_array = explode(' ', $post_dec);

                          for ($i = 0; $i < 60; $i++) {
                            echo $word_array[$i] . ' ';
                          }
                          echo ' <a href="./details.php?post_id=' . $post_row['id'] . '">Read More</a>';
                        } else {
                          echo $post_dec;
                          echo ' <a href="./details.php?post_id=' . $post_row['id'] . '">Read More</a>';
                        }
